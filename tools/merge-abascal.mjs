...
const FCE = 'games/FCE';
const CANON_ID = 'abascal-vicente-ignacio';
const OTHER_ID = 'abascal-vicente-i';
const CANON_NAME = 'Abascal Vicente, Ignacio';
...
console.log(`Fusionado en ${CANON_ID} (${CANON_NAME})`);
